...
class DynamicWidthSpinner : Spinner {
    ...
    override fun setAdapter(adapter: SpinnerAdapter) {
        super.setAdapter(WrapperSpinnerAdapter(adapter))
    }

    inner class WrapperSpinnerAdapter(private val baseAdapter: SpinnerAdapter) :
        SpinnerAdapter {
